package ktxdev.b0mb3r.controller

import com.github.kittinunf.fuel.core.FuelManager
import com.github.kittinunf.fuel.core.interceptors.LogRequestAsCurlInterceptor
import com.github.kittinunf.fuel.core.interceptors.LogResponseInterceptor
import ktxdev.b0mb3r.phone.Phone
import ktxdev.b0mb3r.service.Service
import ktxdev.b0mb3r.service.services
import ktxdev.b0mb3r.utils.Observable
...
class Bomber (phone: String, fn: Bomber.() -> Unit = {}) : Observable<StateUpdate> {
    ...
    fun start(count: Int, cycleMeta: CycleMeta = CycleMeta()) {
        ...
        val requested = Math.min(services.size, count)
        var resulted = 0
        var success = 0
        services.shuffle()
